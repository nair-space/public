...
@section('content')
    <div class="auth-container" style="max-width: 600px;">
        <div class="card">
            <h2 style="margin-bottom: 1.5rem;">Log New Trade</h2>
            ...
            <form action="{{ route('trades.store') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div class="form-group">
                        ...
                        <select id="type" name="type" required>
                            <option value="buy" {{ old('type') == 'buy' ? 'selected' : '' }}>Buy (Long)</option>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" id="trade_date" name="trade_date" required
                        value="{{ old('trade_date', date('Y-m-d\TH:i')) }}">
                </div>

                <div class="form-group">
                    <label for="notes">Notes/Reasoning</label>
                    <textarea id="notes" name="notes" rows="4"
                        placeholder="Why did you take this trade?">{{ old('notes') }}</textarea>
                </div>

                <div style="display: flex; gap: 1rem; margin-top: 1rem;">
                    <button type="submit" class="btn" style="flex: 1;">Save Trade</button>
